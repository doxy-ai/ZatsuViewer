...
Filename: "{app}\pythonFinder.bat"; WorkingDir: "{app}"; Parameters: "-m pip install colour flask<3 flask_socketio packaging customtkinter requests requests-html userpaths"; Description: "Install Needed Python Dependencies (Recommended)"; Flags: postinstall runascurrentuser shellexec waituntilterminated;
